...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Reservasi Selesai</p>
                    ...
                    <table id="table-data-penitipan" class="display w-100 table table-bordered">
                        ...
                        @foreach($data_penitipan as $p)
                            <tr>
                                ...
                                <td>{{ $p->paket->nama }}</td>
                                <td>{{ $p->penitipan->check_in }}</td>
                                <td>{{ $p->penitipan->check_out }}</td>
                                <td class="text-center">
                                    <a href="/reservasi-selesai/{{ $p->id }}/detail"
                                       class="btn btn-sm btn-info btn-edit"
