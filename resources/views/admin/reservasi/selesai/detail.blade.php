...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Detail Reservasi Selesai</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/reservasi-selesai">Reservasi Selesai</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Reservasi Selesai
                </li>
            </ol>
        </div>
        <div class="w-100 p-2">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <a href="/reservasi-selesai/{{ $data->id }}/cetak" target="_blank"
                               class="btn btn-success w-100" id="btn-submit">
