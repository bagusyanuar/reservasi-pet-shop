...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Detail Waiting List Reservasi</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/reservasi-waiting-list">Waiting List Reservasi</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page"> Detail Waiting List Reservasi
                </li>
            </ol>
        </div>
        <div class="w-100 p-2">
