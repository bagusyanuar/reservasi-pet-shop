...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Ongoing Reservasi</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Ongoing Reservasi
                </li>
            </ol>
        </div>
        <div class="w-100 p-2">
                    ...
                    <table id="table-data-penitipan" class="display w-100 table table-bordered">
                        ...
                        @foreach($data_penitipan as $p)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="/reservasi-ongoing/{{ $p->id }}/detail"
                                       class="btn btn-sm btn-info btn-edit"
