...
@section('content')
    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Paket</p>
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                <li class="breadcrumb-item">
                    <a href="/dashboard">Dashboard</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="/data-paket">Paket</a>
                </li>
        ...
        <div class="w-100 p-2">
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-6 col-sm-11">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="/data-paket/patch">
                                @csrf
                                ...
                                <div class="form-group w-100 mb-1">
                                    ...
                                    <select class="form-control" id="tipe" name="tipe">
                                        <option value="grooming" {{$data->tipe == 'grooming' ? 'selected' : '' }}>Grooming</option>
                                        <option value="penitipan" {{$data->tipe == 'penitipan' ? 'selected' : '' }}>Penitipan</option>
                                    </select>
                                </div>
                                <div class="w-100 mb-1">
